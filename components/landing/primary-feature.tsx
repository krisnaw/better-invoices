...
const features = [
  {
    ...
    description:
      'Build branded invoices in seconds with saved templates, line items, and taxes that fit your workflow.',
    image: screenshotPayroll,
  },
  {
    title: 'Automate follow-ups',
    description:
      'Schedule gentle nudges and past-due reminders so you never chase payments manually again.',
    image: screenshotExpenses,
  },
  {
    title: 'Track payment status',
    description:
      'See who viewed, paid, or is overdue at a glance, and keep every invoice update synced instantly.',
    image: screenshotVatReturns,
  },
  {
    title: 'Understand cash flow',
    description:
      'Stay ahead with real-time revenue insights and exportable reports for your accountant or stakeholders.',
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Invoiceku keeps invoicing, reminders, and cash flow tracking in one place so you can focus on client work.
          </p>
        </div>
        <TabGroup
